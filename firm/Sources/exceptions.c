...
/*
 ...
 __declspec(weak) vectorTableEntryType vector_114 @Vcanwu = asm_exception_handler;
 __declspec(weak) vectorTableEntryType vector_115 @Vcanerr = asm_exception_handler;
 __declspec(weak) vectorTableEntryType vector_116 @Vcanrx = asm_exception_handler;
 __declspec(weak) vectorTableEntryType vector_117 @Vcantx = asm_exception_handler;
